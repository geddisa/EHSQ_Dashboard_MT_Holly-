...
# -----------------------------------------------------
# HEADER SECTION WITH PERFECT VERTICAL CENTERING
# -----------------------------------------------------
...
with header_right:
    st.markdown(
        "<h1 style='margin: 0;'>EHSQ KPI Dashboard</h1>",
...
def load_all_data():
    ...
    return {
        "Risk_Mitigation": pd.read_excel(
            "RiskNotifications_All_MTH_2026-07-23.xlsx",
            sheet_name="Sheet1"
        ),
        "Incidents": pd.read_excel(
            "IncidentReports_All_MTH_2026-07-23.xlsx",
            sheet_name="Sheet1"
        ),
        "FSI": pd.read_excel(
            "EHSQ Metrics.xlsx",
